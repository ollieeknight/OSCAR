...
if [ ! -f "oscar-count_latest.sif" ]; then
	echo "Pulling OSCAR count image, this might take some time..."
	echo ""
	apptainer pull library://romagnanilab/default/oscar-count:latest
fi
