...
check_base_masks_step2() {
    if [[ ${reads} == 3 ]]; then
        ...
        base_mask_SI_3prime_v3_GEX='Y28n*,I8n*,N*,Y91n*'
        base_mask_SI_3prime_v3_ADT='Y28n*,I8n*,N*,Y91n*'
        base_mask_SI_5prime_v1_GEX='Y26n*,I8n*,N*,Y91n*'
        base_mask_SI_5prime_v1_ADT='Y26n*,I8n*,N*,Y91n*'
        base_mask_SI_5prime_v1_VDJ='Y26n*,I8n*,N*,Y91n*'
...
check_base_masks_step3() {
    ...
    echo "${cellranger_command// /.}" "${index_type// /.}" "${filter_option// /.}" "${chemistry// /.}" "${base_mask// /.}"
}
