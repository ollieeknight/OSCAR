...
async function metadataFetchRowTemplate() {
    try {
        const response = await fetch('/OSCAR/tools/helpers/row_template.html');
...
// Function to delete a row from the metadata table
function metadataDeleteRow(button) {
...
async function adtFetchCSV(file) {
    try {
        const response = await fetch(`/OSCAR/tools/${file}`);
        if (!response.ok) {
